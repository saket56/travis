...
class FridayConfig(tk.Toplevel): 
    ...
    def __init__(self, root, **kwargs): 
        ...
        self.gif_list = [tk.PhotoImage(file=self.gif_file, format=f'gif -index {i}') for i in range(self.gif_frames)]
        ...
        self.gif_img_lbl = tk.Label(self.screen, image=self.init_image, bg="white")
        ...
        self.label = tk.Label(self.screen, textvariable=self.init_str, anchor='center')

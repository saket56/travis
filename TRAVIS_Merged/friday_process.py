...
class PDFFileCompare(CompareFiles):
    ...
    def get_pdf_file_data(self, file_sublist, db_name, table_name) -> list:
        ...
        for index, file_dict in enumerate(file_sublist):
            thread_name = "Thread-" + str(index)
            t = Thread(target=self.load_pdf_file_data, args=(file_dict,
                                                             self.output_location,
                                                             db_name,
                                                             thread_name,
                                                             table_name,
    ...
    def load_pdf_file_data(self, file_dict, output_location, db_name=BASE_DATABASE, thread_name="Thread-z", table_name=BASE_TABLE, output_code_page="utf-8", output_delimiter=",") -> None:
        """extract metadata of file and insert into the database""" 
